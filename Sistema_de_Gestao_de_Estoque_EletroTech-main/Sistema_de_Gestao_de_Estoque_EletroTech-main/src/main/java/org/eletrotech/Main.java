        ...
        while (!sair) {
            ...
            if (opcao == 1) { // Produto
                if (operacao == 1) {
                    ...
                    System.out.print("\u001B[34m" + "Informe o ID do produto: ");
                    int id = scanner.nextInt();
                    System.out.print("\u001B[34m" + "[1] - Nome\n[2] - Descrição\n[3] - Categoria\nOpção: ");
                    ...
                    System.out.print("\u001B[34m" + "Informe a auteração: ");
                    scanner.nextLine();
                    String dado = scanner.nextLine();
                    produtoDao.atualizar(id, coluna, dado);
                    System.out.println("\u001B[34m" + "Produto alterado com sucesso!");
                }
